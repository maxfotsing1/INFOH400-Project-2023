 ...
 * and open the template in the editor. @Temporal(TemporalType.DATE)
 */
package model;
...
import static model.Patients_.idpatients;
...
public class Rdv implements Serializable {
    ...
    public String toString() {
        ...
        String dab = "unknown";
        if( daterdv != null ){
            dab = fmt.format(daterdv);
        }
        SimpleDateFormat fmtt = new SimpleDateFormat("hh:mm:ss");
        String dtb = "unknown";
        if( heurerdv != null ){
            dtb = fmtt.format(heurerdv);
        }
        return "idrdv= " + idrdv + ", "+ "date RDV = "+ dab + ", " + "Heure RDV = "+ dtb + ", "+"Patient Info : " + patients + ", "+"Doctor : " + docteur;
    }
